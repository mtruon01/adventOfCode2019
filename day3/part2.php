...
$wire1Direction = explode(",", $wire1);
$wire2Direction = explode(",", $wire2);

$circuitBoard = [];
$intersections = [];

drawWire($circuitBoard, $wire1Direction, 1, $intersections);
drawWire($circuitBoard, $wire2Direction, 2, $intersections);

print_r($intersections);
asort($intersections);
print_r(reset($intersections));

/**
 * @param array $circuitBoard - the current circuit board
 * @param array $wireDirections - all the directions to draw the wire
 * @param int $wireID - the wire ID
 * @param array $intersections - an array contains all the intersections on the circuit board
 */
function drawWire(array &$circuitBoard, array $wireDirections, int $wireID, array &$intersections): void
{
    $intersections = [];
